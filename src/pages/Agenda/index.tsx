    ...
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4">
        {/* <Link to="/" className="block mb-8 group">
          <Card className="backdrop-blur-xl bg-linear-to-r from-[#E1FF2F]/20 via-[#00FFFF]/20 to-[#E1FF2F]/20 border border-[#E1FF2F]/40 overflow-hidden hover:border-[#E1FF2F]/70 transition-all duration-300 hover:scale-[1.02] cursor-pointer">
            <CardContent className="relative p-6 md:p-8">
              <div className="absolute inset-0 rounded-lg bg-linear-to-r from-[#E1FF2F] via-[#00FFFF] to-[#E1FF2F] opacity-0 group-hover:opacity-10 blur-xl transition-opacity duration-500" />
              <div className="relative flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div className="flex items-center gap-3">
                  <Sparkles className="w-6 h-6 text-[#E1FF2F] shrink-0" />
                  <div>
                    <h2 className="text-2xl md:text-3xl font-black text-[#E1FF2F]">
                      Código da Sala Profética
                    </h2>
                    <p className="text-white/80 text-sm md:text-base">
                      Consulte seu horário e local de atendimento
                    </p>
                  </div>
                </div>
        ...
        <div className="max-w-4xl mx-auto">
          <Tabs defaultValue="21/11" className="w-full">
            <TabsList className="grid w-full grid-cols-2 mb-2 bg-white/10 border border-[#E1FF2F]/30 backdrop-blur-xl rounded-2xl p-2">
              <TabsTrigger
                value="21/11"
                className="rounded-xl data-[state=active]:bg-linear-to-r data-[state=active]:from-[#E1FF2F] data-[state=active]:to-[#B8FF00] data-[state=active]:text-[#003280] data-[state=active]:shadow-lg text-white/60 hover:text-white transition-all font-bold text-lg"
              >
                21 de Novembro
              </TabsTrigger>
              <TabsTrigger
                  ...
                  >
                    ...
                    <CardContent className="relative p-6 md:p-8">
                      <div className="flex flex-col md:flex-row md:items-center gap-4 md:gap-6">
                        ...
                        {/* Divider */}
                        <div className="hidden md:block w-px h-20 bg-linear-to-b from-[#E1FF2F] via-[#00FFFF] to-transparent opacity-50" />
